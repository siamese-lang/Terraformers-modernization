...
assert_contains 'SPRING_PROFILES_ACTIVE' "${RUNTIME_MANIFEST}" "Runtime manifest must set SPRING_PROFILES_ACTIVE."
assert_contains 'SPRING_PROFILES_ACTIVE: prod|value: prod' "${RUNTIME_MANIFEST}" "Runtime manifest must run with prod profile."
